package hr.fer.lukasuman.game.test;
...
public class PathTest extends GdxTest {
    ...
    public void create () {
        ...
        obj = new Sprite(new Texture(Gdx.files.internal("test/badlogicsmall.jpg")));
        obj.setSize(40, 40);
        obj.setOriginCenter();
        obj2 = new Sprite(new Texture(Gdx.files.internal("test/bobrgb888-32x32.png")));
        obj2.setSize(40, 40);
